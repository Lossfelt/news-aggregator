export const feedSources = [
  ...
  { name: 'Practical AI', url: 'https://feeds.transistor.fm/practical-ai-machine-learning-data-science-llm' },
  { name: 'Cognitive Revolution', url: 'https://api.substack.com/feed/podcast/1084089.rss' },
  ...
  { name: 'OpenAI Research', url: 'https://raw.githubusercontent.com/Olshansk/rss-feeds/main/feeds/feed_openai_research.xml' },
];
